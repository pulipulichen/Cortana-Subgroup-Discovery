...
public class StatUtils { //calculate a p-value based on an array
    ...
    public static double PValue(double t, double df) {
    	return StatUtils.regularizedIncompleteBetaFunction(0.5 * df, 0.5, df / (df + t * t));
    }
