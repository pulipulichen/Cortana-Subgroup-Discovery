...
public class DistributionTable extends JTable
{
	...
	public DistributionTable(Table theTable, Subgroup theSubgroup)
	{
		if (theTable == null)
		{
			MEMBERS = null;
		...
		super.setModel(new DistributionTableModel(theTable));
